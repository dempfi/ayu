...
function getThemeColors(variant) {
    ...
    return {
        ...
        'editorWhitespace.foreground': scheme.syntax.gutterFg,
        'editorIndentGuide.background': scheme.syntax.gutterFg,
        'editorLineNumber.foreground': scheme.syntax.gutterFg,
